  ...
  return (
    <section style={{
      ...
      <div style={{
        ...
        width: '40%', height: '100%',
        background: 'radial-gradient(ellipse at top right, rgba(26,86,219,0.06) 0%, transparent 70%)',
        pointerEvents: 'none',
      }} />
      ...
      <div style={{ maxWidth: 680, position: 'relative' }}>
        ...
        <p className="animate-fade-up delay-3" style={{
          ...
          We build clean, professional websites for local Frederick businesses —
          fast, affordable, and completely hassle-free. You focus on your work.
          We handle the web.
        </p>
